//NBLDXWRP  JOB (ACCT),'GENEVAERS BUILD ASM',                                    
//          NOTIFY=&SYSUID.,                                                    
//          REGION=0M,                                                          
//          CLASS=A,                                                            
//          MSGLEVEL=(1,1),                                                     
...
//*                                                                       
//*********************************************************************         
//*  ASSEMBLE AND LINK ASSEMBLER GVBXWRPT WRITE EXIT
//* 
//*  This module examines all the exits in a GenevaERS pass and
//*  reports when and how they were assembled/compiled and linked.
//* 
//*********************************************************************         
//*                                                                             
//         EXPORT SYMLIST=*                                                     
...
//*                                                                             
//SYSIN    DD DSN=&HLQ..&MLQ..EXITS.ASM(GVBXWRPT),                                
//            DISP=SHR                                                          
//*                                                                             
...
//*                                                                             
//**********************************************************************        
//*  LINK-EDIT GVBXWRPT      APF Authorized
//**********************************************************************        
//*                                                                             
//GVBXWRPT EXEC PGM=IEWL,                                                       
...
//            BUFNO=1                                                           
//*                                                                             
//SYSLMOD  DD DSN=&HLQ..&MLQ..EXITS.GVBLOAD(GVBXWRPT),                                                             
//            DISP=SHR                                                          
//*                                                                             
//SYSPRINT DD SYSOUT=*                                                          
//*                                                                             
