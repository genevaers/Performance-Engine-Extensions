//NBLDMRP  JOB (ACCT),'GENEVAERS BUILD ASM',                                    
//          NOTIFY=&SYSUID.,                                                    
//          REGION=0M,                                                          
//          CLASS=A,                                                            
//          MSGLEVEL=(1,1),                                                     
...
//*                                                                             
//SYSIN    DD DSN=&HLQ..&MLQ..EXITS.ASM(GVBMIGRP),                                
//            DISP=SHR                                                          
//*                                                                             
...
//**********************************************************************        
//*                                                                             
//GVBMRP   EXEC PGM=IEWL,                                                       
// PARM=(AC(1),XREF,LET,LIST,MAP,RMODE(24),REUS(RENT))                
//*                                                                             
//SYSLIN   DD DSN=&&OBJECT,                                                     
//            DISP=(OLD,DELETE)                                                 
//*                                                                             
...
//            BUFNO=1                                                           
//*                                                                             
//SYSLMOD  DD DSN=&HLQ..&MLQ..EXITS.GVBLOAD(GVBMIGRP),                                                             
//            DISP=SHR                                                          
//*                                                                             
//SYSPRINT DD SYSOUT=*                                                          
//*                                                                             
